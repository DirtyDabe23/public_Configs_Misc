function Get-uniqueParentCompanyUser{
    ...
    Get-uniqueParentCompanyUser -UserPrincipalName "David.Drosdick@uniqueParentCompany.com" -Full -Domain "uniqueParentCompany.com"

    .EXAMPLE
    #Get the User Data from Graph
    Get-uniqueParentCompanyUser -UserPrincipalName "David.Drosdick@uniqueParentCompany.com" -Graph
   
    .EXAMPLE 
    #Get the User Data from the Local Domain 'uniqueParentCompany.com'
    Get-uniqueParentCompanyUser -UserPrincipalName "David.Drosdick@uniqueParentCompany.com" -LocalAD -Domain "uniqueParentCompany.com"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCD81MGxdp18lzOh
# vr4iXa3EqkQG82HlLziC9VD8xjljAKCCFAUwggWQMIIDeKADAgECAhAFmxtXno4h
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIATn8NBPNrdPgwM1sy8aD7PC
# jSF2JCwMt//iMm6c7wEkMA0GCSqGSIb3DQEBAQUABIICALWDehmAs/OYfD7SRvoB
# VhuZV6ia+xV+XlX7D0GR5rkoIlFYxmAaTLIqIHZIoQ0drxp/c51bD4lonjeCF83B
# OeQvVlUAFIMCa6o+OdSnNb/i6JS7M+zMJFTlQXhcSTTA69ubQhRhFIOEdRPf8geZ
# NM1OWmwK+qaViERix5LUVIEGXpecSyppzDef1OB2E2DQBgkt2uvANJOkqo1zRgVr
# uyEpEERWp5CIpoYgTBmlP6oySpwMCIjot8Qf74cWLQ+0wZGjC4k5tlmi5xlnD9nO
# XSKqOxbU13lVGHxgwQ6pfyIWMoFjobPV3MqnK9e40XA2DJaEeQWGjZz4KBAxoIDA
# HWH9rmvmm+8/U4DQ+ZGRy3/wOyII7iN+cGUFdo7pwsLGgccZJvEEK2/y5tJEyRht
# ElyLysxQIpO+zL6AQ7wLQ+y/M8e94PB7GCFJueFqsawbAn+Vgmxaj1xqqmgiudC/
# YavY550fbpkpw/8RWKGIdkxq4ENWUDkiM8QexmywLS2cvdKxo7bmSQB71l4osbtO
# FrbTI4zR2nrJV+gpDUzRLhTIiPPixob+eqsCXGSB8M+ERyZfiy0zSuLzuI6/O/To
# rAVDDQW23SITl6h3C92ArOoWKSrKRiTdfDfLt/ibioW/ClJQBtPsZLzaN59C5jHM
# JZTZiYCZi1cOHtXH0pigvJXXoYIWtzCCFrMGCisGAQQBgjcDAwExghajMIIWnwYJ
# KoZIhvcNAQcCoIIWkDCCFowCAQMxDTALBglghkgBZQMEAgEwgdwGCyqGSIb3DQEJ
# EAEEoIHMBIHJMIHGAgEBBgkrBgEEAaAyAgMwMTANBglghkgBZQMEAgEFAAQg+jns
# b+aW+gQDtIdY99plqYNBTNQdcNtq+vZWdUoINfcCFDx+z6tBJ5qYWAmLc+UXfKU7
# oXjRGA8yMDI1MDQxNjEzNTQzN1owAwIBAaBXpFUwUzELMAkGA1UEBhMCQkUxGTAX
...
# SAFlAwQCAaENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgHwCZL5ZXnR1B
# c0RL+gwEuWyNwavpkFnD9lhg33uRxx4wgbAGCyqGSIb3DQEJEAIvMYGgMIGdMIGa
...
# m3hD4Jl1lGN3CzANBgkqhkiG9w0BAQsFAASCAYAcQaXhW3DVxBgn/+m+SjbxgrZR
# MjFzPYF7mKeSN39R1it9TXVwTtPqgaLtpOY4B7Mh9jZRuijWMEi4hyf8W/05v4UT
# 9eJSufHDrD1N8WN+IpR6ew/o4OT6ZNCbEEpVkdCAOZBQMS7fBNa00W/FrFoGqha0
# Rp/JM8Zb0ol28YL/wWj6AZPGaCPDhWkU6DJK4gHCVIOWLflphNzbGPYB9lM70sbf
# o5sGo5LHBFa4yG1ODj64aKJ/4BWa6YU9U2Wo3OFgiFCX3LDFGrQvTiAqagKHuzZH
# WT85ByfTSvX+mVbN39WaNpQohec5a2axOZFPBP6g1Qs485QyV7nU5AIL6Em4mCqk
# qYZAO0hLOzhzKUbY7zTYnW6Xxf6yOP4FzaB+PV9bChrbHTHTJ5rm3A4QVeBZyqiT
# Y4Ja8p7c96w4QgcddDzxmFw0q7XtVVoQ7mGD0IrSgrpzqtLwDHEpS0lODYl4FzZm
# qLGAkSM484NpFxWaTQoNpvcJ1YLRjLls3MQAPvg=
