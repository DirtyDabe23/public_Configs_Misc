...
$sqlcn.ConnectionString = "Server=us-tt-sql-qa1\lob_qa;Integrated Security=true;Initial Catalog=DomainVerification"
$sqlcn.Open()
...
Set-Location "SQLSERVER:\SQL\US-TT-SQL-QA1\LOB_QA\Databases\DomainVerification\Tables\dbo.EmailData"


#read DB data
Read-SqlTableData -ServerInstance "US-TT-SQL-QA1\LOB_QA" -DatabaseName "DomainVerification" -SchemaName "dbo" -TableName "domains"


$trustedQuarantineDB | Write-SqlTableData -ServerInstance "US-TT-SQL-QA1\LOB_QA" -DatabaseName "DomainVerification" -SchemaName "dbo" -TableName "domains"




Write-SqlTableData -ServerInstance "US-TT-SQL-QA1\LOB_QA" -DatabaseName "DomainVerification" -SchemaName "dbo" -TableName "EmailData" -InputData @{'[MessageId]' = $($trustedQuarantineDB.messageID); '[RecipientAddress]' = $($trustedQuarantineDB.recipientaddress); '[SenderAddress]' =$($trustedQuarantineDB.sender); '[Subject]' = $($trustedQuarantineDB.subject); '[ReceivedTime]' = $($trustedQuarantineDB.received); '[Type]' = $($trustedQuarantineDB.type); '[Direction]' = $($trustedQuarantineDB.direction);  } -PassThru
...
Write-SqlTableData -ServerInstance "US-TT-SQL-QA1\LOB_QA" -DatabaseName "DomainVerification" -SchemaName "dbo" -TableName "EmailData" -InputData @{'MessageID' = $messageID; 'RecipientAddress' = $RecipientAddress; 'SenderAddress' =$Sender; 'Subject' = $subject; 'ReceivedTime' = $received; 'Type' = $type; 'Direction' = $direction;  } -PassThru
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDszlHugHBRnJWx
# OqIL7lyU3ZwTY/90QVTutylzDukebqCCFAUwggWQMIIDeKADAgECAhAFmxtXno4h
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIBuVcMe/hRzr2Ueb+jpmA3rg
# QlYzesisF/U4yglbOEyqMA0GCSqGSIb3DQEBAQUABIICAGEBaKJWO+QosfMFIFuu
# oVE+ggq+zLza3Zy1s2V2nfHIHeCE2kqA6Zgu2ZbLXAyNp4JvrWKpx18v4C2rsSCF
# yL0aTM24TFbRHDJ5evQI0REKSIZEmZw4T7VEQoe+OGwzgtTmEQb78bKpfU2LYupw
# xgQkfxAlSrhfIT3v14zEF4M+GX6tjYzw1J9O5wiUfpak5iDN8NfyDBp8YvYNYCZV
# p6yqS10KbSR2eMYmaeNN4QEzv6cGlvfGl5cJwGq4NxcVIW1gtpSzl0Mf5Rv+GCqa
# qqUiT+OdR3asTnGW5fB7BBjjiFN1xehs3nFBoUCO5oeh8hOGWncYKiExtBB1puYH
# c86zmaF6XE6IfSeZIu4hDW7AnVJJoyO34Jew85hZo+iWSy+LF/eEoNJ0QH6vuhAu
# 2HijUGYf5QGaiEkwQh4PDjao6bjCmpkJexyngPBL/QOBtJYAz/0Bv86o5Q0/kwdP
# J/B1rSRU1FppQMVs8bReVDAJ/s6od9docIVX1MxGt6vGNZ+4TTwRlSZN/xmuEMVX
# gsauFjuH1zMH1GHAMmfj+azvsZATFQTx6vX5P6UNFmcmJjkhXHQOqwHU0j1yqigU
# 8Gcccs4l8WxT8fTyE1Kz1w4IYKqLZ0QAdDvEutHl9ShhJNPpiNuVM6rGgeGreqLI
# Sv14vzUee9ObUeOVHIzD4MrkoYIWyTCCFsUGCisGAQQBgjcDAwExgha1MIIWsQYJ
# KoZIhvcNAQcCoIIWojCCFp4CAQMxDTALBglghkgBZQMEAgEwgeUGCyqGSIb3DQEJ
# EAEEoIHVBIHSMIHPAgEBBgkrBgEEAaAyAgMwMTANBglghkgBZQMEAgEFAAQgika1
# LpSDs5qzIIjt4KUQ8sWq08Nov54TRH45yCbg/qwCFDRfkXZMPFlsNLcpTeQAZCIq
# GSc/GA8yMDI0MTIxOTE3NTA1MVowAwIBAaBgpF4wXDELMAkGA1UEBhMCQkUxGTAX
...
# 9w0BCQQxIgQgvQUgxOA4T4unkEF4GW88hEa7RWWIVSgZdcrXfMX07+MwgbAGCyqG
...
# SEEzODQgLSBHNAIQARl1dHHJktdE36WW67lwFTANBgkqhkiG9w0BAQsFAASCAYBN
# dhy0gR8ZW/uwCtZ19hF6KE3/kRDJw1IEs4eytYtSWr5nulPiYOE5DWH+KPMv5n1o
# PYILmnlpZ4006Ma27kDXIYTdfqKNfmqPNkiEPCU5N8ThgjLwuodmYESVX/V5cV7g
# LHTpZpIthOuRaVFLZTpJ/ZCxH3SOT1xgUr0NAsKnIZwMyA3Rda2ku9ff7iFPFb7I
# dLUlqhehT1KFaXCIVIoJrved4bsO+Js8D6+bAX4LN0pBfiV1oovq18Biig0BdB7L
# Fx/Bs5n77ps2XUV+ngmFyOlDl4EOfqXXcWHmTxUpCISEgkKbbTF+6uCd5+MJ+/u6
# mRERt9BqlM0Yy4W+Y0hSKuW3G1KKQaGRt7MZG3MGDV8OqG+nXrWd9bacS5QQcUMr
# fWOw8+tDCjVU8JSIPEJ5mgdYQOggcTrl4vyLiI1ih4QwFSSJQ6m6vEcl1mPAifA5
# Id/DnnnZttx3QJCHoQpGCPwcPlbo0CqsKurXPeKzcJa5ekKLlWwJu3CMw95pcOg=
