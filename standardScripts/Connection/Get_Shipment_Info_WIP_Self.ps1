...
if ($null -eq $key)
{
    $key = Read-Host "Enter the Jira Ticket Key"
}
#Connection via the API or by Read-Host 
If ($null -eq $connectionRetrSecret)
{
    $connectionRetrSecret = Read-Host "Enter the Connection API Key" -MaskInput
}
else {
    $null
}
...
$connectionHeader = @{
    ...
    "Accept"        = "*/*"  # seting Accept header for expected response format
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCD86/9W9m7ADzAG
# sNvA7qvvFDkzJCQOYq6e6LHDkLwEx6CCFAUwggWQMIIDeKADAgECAhAFmxtXno4h
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIGlI3mpbNILPmeBqshwATkfx
# 94kU0hNybJW/D+7uQ+wGMA0GCSqGSIb3DQEBAQUABIICAIcGuIkaCI7aEfIlL39Q
# DeJvIL6zYMS7waYCh9hFMqM4JOx6VdIDecCYxgcjhCl8mnIBrtyZnvPxDObtVUsz
# C+tQ2HWA4UTrWKvwqGCz+gllmzoMUq/6pQHF8ICO//7hmuU7H3MDR8mTwwV19JER
# ayu32L7+8RFCzf7eT5y7M65yxbMY9yf+B8tlSjycRliiEaleQ1fTs2Xrg19wHuKh
# 6ufnhCdQH4Ga63PXF5y2ltJelMdjvTyJUsOQJbVZGbokP93gPSOzNCZUnbeg5x/t
# FnhD5O7uIpw3ghv+mCerhpRkBwFMlsnkLbDIyAVlY8wXG4riRRvDWD1MtAT/30IN
# OzeeUj1GZSBZHd8iKP53uRRLa88hfon5o3hn2t836CObKnKCpIiFV7idl0cVujy2
# +cKcuIexWXPVQI4+xBhtT29ljqPgYGsKmakAHMU7/ziTpSvsZIhfzz+k5BuWGvHi
# 064+5bGkc+QHikSqqnG99vdo5D/bMKAylSXq2y5pgvQBxm330/w7tJ00a8TvRoyH
# i/BKR5RVtYGPDfIDEfZ269FGQsZSqfkn8M4C3RvQlWNAOeR7VwQkt67tIw8aBYw2
# RQqTaHpcH7YSysdA2KrywqJUGt3n+k3ManonSubsidiary-19yYSfDKLw3zslIEc88BlrKmuj1ALk
# UO+1hihh8Vxi07/gLGsz6ADRoYIWyTCCFsUGCisGAQQBgjcDAwExgha1MIIWsQYJ
# KoZIhvcNAQcCoIIWojCCFp4CAQMxDTALBglghkgBZQMEAgEwgeUGCyqGSIb3DQEJ
# EAEEoIHVBIHSMIHPAgEBBgkrBgEEAaAyAgMwMTANBglghkgBZQMEAgEFAAQgcA+K
# I58KtVHBS+bPpE9Fe1v97f9r6p7WiJU+OvQdP30CFBH2hiYmDX8XAfk2sWN7Db3k
# 8hmbGA8yMDI0MTIxOTE3NTk1NlowAwIBAaBgpF4wXDELMAkGA1UEBhMCQkUxGTAX
...
# 9w0BCQQxIgQgCxlwNY9aG8oot84GPoBGNrGIe9snBssu4+rJH66uvlkwgbAGCyqG
...
# EW8S6d8xPVsJN/TtSeEoHKbjTaMuv03+JSId+ULjaMJuTkwzyIB4ho2xzdHG2Ecb
# K0GqQb9xp+YvVp+ef/peWGIvi/dkJ48+X2abCdlT1M13emuWyWhoHfRpjl9pOAVo
# KyfJmLCp1jhY+umZG9h0bT7jfym0KTHKdO+9J+1dIql5q+ZkNak5soLdnJJWk83U
# xLHMO+64nrjNMjzSGHNHBUmnWuYon7IN8eqpWllof3okD2f5DLvgXSACUDtIGCom
# AAXdRP3jFDaRNH0fl1IZUG7seLPejReIbfpAEF0cAox5j7GXv7SRR1nRykgeVR++
# sSVkRqHcafrTIKW+icH0UuVLoU+D81kfkiY7g9Yz6OFdu1zrh8TJ/IPtYVWxyTAO
# 0qFZb46wa3lsCSd1JDeqIDEznVpXGYbRWTDhvW27EFpSRmDtm+FaPEe0xu9pPq25
# rMaLTII+2LVqGfvIy/+Og7dC3gbsdNpCm7BBZt4aJI6HjYJiPjzmLOv8ME+v/og=
