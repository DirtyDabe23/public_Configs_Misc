    ...
    ForEach ($order in $matchingOrder)
    {
        ...
        $payload = @{
            "update" = @{
                ...
                "customfield_10933" = @(@{
                    "add" = "$vendorOrderDate" # Replace with your label
                })
                "customfield_10934" = @(@{
                    "add" = "$vendorShipmentID" # Replace with your label
                })
                "customfield_10935" = @(@{
                    "add" = "$vendorShipDate" # Replace with your label
                })
                "customfield_10936" = @(@{
                    "add" = "$vendorTrackingNumber" # Replace with your label
                })
                "customfield_10937" = @(@{
                    "add" = "$vendorTrackingLink" # Replace with your label
                })
            }
        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA2VAKMbCrKiRug
# /SuBaVwqTbuNy+me3532KefVItbpQaCCFAUwggWQMIIDeKADAgECAhAFmxtXno4h
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEICCRRS08Rqo1alIjJF04JDPh
# wVpox4ShX5C6Fq2htvNEMA0GCSqGSIb3DQEBAQUABIICAIDmnbsR7MmmrIcfgWb3
# xjBoin1aON++NP96SCaUWlbP4Nehi7J4uHk9Cf1e5VJ22y9P3pL03RYE0tlTE8HS
# yDV8MFqvwbBSXF0EPoJ8dfgW87eU+8p4mmpzcUeCPiURPKCvBeWCwsK3l+y170LH
# mS0CL/XuafftdaErcKRNfrEntvxpCQ5UCSKc6fPGdv7lGyBUwlfF0sc6j52Blzam
# +mo1pzvUGYWrve5jT8rQb+F3VPr14Kf3d8u/ife/DvkHLr+ZvUi0fJ//4JI18m8y
# 5OxRdQzwDKxeQmS35quU8yEMAJFzUpWT57sFFXREmLvdz7YPM9tF7Z+8NBiuvoH3
# W2dq37HY2tZeVjdkyezE6b6Sybs/RwfBDsgtTZHQqNeIB3HnHm8hIyDmxac5Qqdf
# wWklcLU4MPE329aWHhTPwgrQ0fxWy3fOn0rJIbtAgZYUR1wM9x9lbSBaACTFpDC1
# 8qzo8fVj/FhTdIPLPVruNgmUgGVosMsf5/hAVFD85hDrt1qXLurdpSdWqjyaOFec
# toTre1AieXmThhP/fxt00rJZxOfqwIwyk7YKe0As9hFtzQSPlgU9dHEwprtnrDtn
# K3yq3k+Naxtw/eEFhgUSX39Q+HcmyOIJbwsf0tcjoZg8ZZkNrDLTtvTpqjc6mOpf
# MsJZafsB6VUlEc6cojYWS+uLoYIWyTCCFsUGCisGAQQBgjcDAwExgha1MIIWsQYJ
# KoZIhvcNAQcCoIIWojCCFp4CAQMxDTALBglghkgBZQMEAgEwgeUGCyqGSIb3DQEJ
# EAEEoIHVBIHSMIHPAgEBBgkrBgEEAaAyAgMwMTANBglghkgBZQMEAgEFAAQgp0Pe
# kzXeoY1qWKi2nn6io8BeJSQb4aMnQxPCR6iCixYCFEVFcrnhAjjOcyVHTJmohaWh
# 3SFUGA8yMDI0MTIxOTE3NTk1N1owAwIBAaBgpF4wXDELMAkGA1UEBhMCQkUxGTAX
...
# 9w0BCQQxIgQgTtnnCEVjQQHVsfNrslLDoDhKiXwj9hBay/bZOurdrQUwgbAGCyqG
...
# SEEzODQgLSBHNAIQARl1dHHJktdE36WW67lwFTANBgkqhkiG9w0BAQsFAASCAYCZ
# Yw2tKaSuwkORWVhZOu3tT6pGX5qWdtWi/NlBdz5vx5xssDU1f3W3itKlReBP5KGq
# mPsvrtZR4bSBOQBgXAVDKCoQRSiTXE9cCm5JNJuj5RHXWtlnCubDoQXE61gufFdQ
# fdeu6DjXPpBvwtHbw6SaHB+PmRE5owiY3ONWI9FhOhOxAraRiOPAJs0UrMflP/wy
# RyDrxjlvzmLRi/sdswgcdCROw7JGMX4RCuMBLWbINojqQKac1T4AGISO++98ORsu
# ddyZpuKrkNyBk5tO4K3oW7OyRfxc3v3vhTRl5W1hsg2dLuy+9QFtKkXfQETMqgie
# B+3Up5kIZJas8zvDoW+/gzLMaNJLCZyKTrC1cioALzKDL7fck1htEkhZ2Z8pxBv1
# gfl1pZfVC1nNmXRC7sDp34o1keV7sUrlvx9jeEBr9yufNq0GTPWSJvy1KCmE6tYk
# M1vzjQLY2SbkyPF4ogBEFGc78fK/SXMEAvcnhzv1TLPc0Ea0+Qn20Syxfli0viY=
