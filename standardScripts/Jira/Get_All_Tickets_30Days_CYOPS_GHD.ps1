...
$retrSecret = (Invoke-RestMethod -Uri "https://us-tt-vault.vault.azure.net/secrets/$($vaultName)?api-version=2016-10-01" -Method GET -Headers @{Authorization="Bearer $jiraToken"}).value


#Jira Header
$jiraText = "david.drosdick@uniqueParentCompany.com:$retrSecret"
...
$ticketsMatching = @()
$uriTemplate = "https://uniqueParentCompany.atlassteamMember.net/rest/api/2/search?jql=project%20in%20(CYOPS,GHD)%20AND%20created%20%3E%3D%20-$numberofDays&startAt={0}"
...
Write-Output "The list for all tickets created within the past 30 days that were closed:`n"
...
Write-Output "The list for all non-security tickets created in the past 30 days that were closed:`n"
...
Start-Sleep -seconds 5
$requestTypeTicketCount | sort-object -Property Count -Descending
...
Write-Output "The list for all tickets created in the past 30 days that were closed:`n"
Start-Sleep -seconds 5 
$requestTypeTicketCount | sort-object -Property Count -Descending
# SIG # Begin signature block
# MIIuqwYJKoZIhvcNAQcCoIIunDCCLpgCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA6vlRW5icl8g5V
# sysYV3+ndAwYnB7xHcpOv/cw9HKbH6CCFAUwggWQMIIDeKADAgECAhAFmxtXno4h
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIEZfY3JtFOJx+I4416Lk18Dd
# WBP4i9ODtJ9AKftNMSmpMA0GCSqGSIb3DQEBAQUABIICAHjGl6j0R9JXFZqqBHMR
# aAk309aGaU+LykZBva47qlOJjHKJo226M00Hsd8ndAgT7A3+ksE8PB+jtRtTmNU0
# rYarBIJVopcq+zPRWW/wUe2XCflJf1dWS8zZbvbKjH2oa91StRLQzmlXsuqWwitJ
# fAr3rD56Kv2O2HixyrM1wANs+eudNeofxgkksWoQjLGGSVvGQdRodZ9KXD/WON18
# /PXxOZ0kb4xC6ETfkT2BmS8vXVL9uRPZvaFqXppJASn7G8+J7hTU9PfE+JmtZt+x
# Wn3ndW0Nq2o3fViUTPVmtyJFguZpN8rtRIQ4LcYk202TfI+VrI47n7MMwlRRKnK1
# qcA+KKhYJrwr/mOtR7ga8WD2YZi6b9trz+GViR93WG+ZKvmL6VhnV0vdRc78RsP/
# mdFQLdBS4Ygo70V1jyKRaNYpEYdMKz/JOk1FLrajpKkjFFDRM9CZMdypi751Du2+
# gxvcbWsjP9JVeIf+/tHwkjl++ASxL9u99iNKKzkXcheT0CusLMv58vluaUtFPIpd
# gXi93cNMjwNvO5WyXJVoq+DXcICAooddEZztlQsbUqUPNNPStna+hU2mOrw+yUH+
# 3FkvQtxMVLq6j4ZTvsnZhCed3V+tfjvjf+DBDxBaTfvdZTY9q7Xuetqf9Cl9Oh5z
# /w9j8ZwKn+pE6fDHxO05yMPIoYIWyTCCFsUGCisGAQQBgjcDAwExgha1MIIWsQYJ
# KoZIhvcNAQcCoIIWojCCFp4CAQMxDTALBglghkgBZQMEAgEwgeUGCyqGSIb3DQEJ
# EAEEoIHVBIHSMIHPAgEBBgkrBgEEAaAyAgMwMTANBglghkgBZQMEAgEFAAQgtnlO
# +yTwGRhsw9nBm3pmLTTFimnCzMJEEH/vhuauE/YCFFM48D/jA5u8DdoaO8Ss7A4a
# GU0lGA8yMDI0MTIxOTE4MDUxOFowAwIBAaBgpF4wXDELMAkGA1UEBhMCQkUxGTAX
...
# 9w0BCQQxIgQgbHMza0zf0hz2y2+LHYO1EB42up0lFERDjybAXx1TLZwwgbAGCyqG
...
# SEEzODQgLSBHNAIQARl1dHHJktdE36WW67lwFTANBgkqhkiG9w0BAQsFAASCAYBk
# 22juBSa1sTIBQSx92eXYXf3Zt9x+jTQBN/ed0jeWeP/YFnw4LVNHepNvaUsW8OCh
# GQ7Z3MhhDSfV3n4+UvMqpTgSMt5slouMzOA3uWpoVKbUu9CzqqpWSv78I5WDfBGL
# 7s0lGPX/bAUIHCvKYslBhvPkKeHLop0eXgKTsQiwGEm+wEQ0lEGY/Ilf0M4oL9VT
# ia3sXDjictYDy4YJammKoagUSm9vVifCSQDfzbKiY7RWvhhlEptpIFipM62iOGMX
# SAPFMta6WanonSubsidiary-16yC8MnaTqjRMLBnHy171sV+xcXJYnZ4LrkJuNGLXwCi7FAJGoOkP
# PZaZQrs6+IBx2J79kk1rm6cc6uj5lmt4kcjFDwrDKoM9E1JFf5x1sDvR1qPXhHrH
# 0ykU6rttSham+YgUIvo+zlmPaql/Wc0I50H9z7jkHVMT/0OOrYSnbpJh83zEV6ck
# 0uqIuZknHZVPR5DSjIEQGOIZtAVJb/RYGkjlLDqhNYuKZ5CL5zIeXBnz0SlgnAQ=
