...
#The Graph API URL
$uName = "david.drosdick@uniqueParentCompany.com"
$uri = "https://graph.microsoft.com/v1.0/users/$uName"
 
$method = "GET"
 
# Run the Graph API query to retrieve users
$output = Invoke-RestMethod -Method $method -Uri $uri -ContentType "application/json" -Headers @{Authorization = "Bearer $token"} -ErrorAction Stop

ConvertFrom-JSON -InputObject $output

https://graph.microsoft.com/v1.0/users/$newID.id/teamwork/installedApps
# SIG # Begin signature block
# MIIuqwYJKoZIhvcNAQcCoIIunDCCLpgCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAH/RrmMIdlWDml
# U3V1hz7b0MNiGWE1W1ESAQwcrC4Lw6CCFAUwggWQMIIDeKADAgECAhAFmxtXno4h
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIFroXiBgkc7TmO5bjrVVb56b
# DAhx/f9O4mqrOnPQBVG1MA0GCSqGSIb3DQEBAQUABIICALJflBEtiSCs2pELOh3T
# pMVKUJdA56SLC5O1Ob8yKcQceJ4YNz8WLa3kT3LO96MmMDswt6hQP0SvcGbHrndz
# JObHJCpmOv6ugtxqPnZzluteGaUWhJv9LFGeesmBsiHi2uSl0VHpFuLz+gODsfLj
# IulUpZXtPN2hsCEgH0zENdvFG+mv/ivcnmYV0t5r3dIE1wsqwwpkf3yv/K5lggP+
# xzKbSlTywX5GWmRrk2IzcgW9qGKqPKP9VJgGNL4MlUP4O5vUNpshwG8KLSrhMMzK
# VdKRlvFjjyKGDFYuSnaZIshuFbscYiGpcRK1vR/VjIahfoUA/+aIQEHv6kWGTD9z
# V8/7Unxsm7pyGM2irRWvkLpr3hc7bjvI8A7ay40nCe2vCU9BzpJm3R/2sm/uSF8n
# UWjNiXC2rFqREej62JgaPoYZwhHQFZIfQ/XIDL1OqadxO/3otrtfV759AcGK8Le4
# /731w25YY4CSDF504hD1SORZ5RlZup8SCEjgU+AQ8JHau+6bP/9BcbHLmmDmkZ6M
# F86tDdAJyqDwHADmvcgETXCGP3aQQ/aZ75YxmFPQ6r2nf8vGiJBDbZqUdSDGWu/A
# /Hx7cgsHdTVpeTC1uhzakBsyGZxhPEcrC2ZKl+LmhLgZPehw3BVrG7S58jI+yP/C
# IJLZuuPgu2X8s6KK1cVg8VSRoYIWyTCCFsUGCisGAQQBgjcDAwExgha1MIIWsQYJ
# KoZIhvcNAQcCoIIWojCCFp4CAQMxDTALBglghkgBZQMEAgEwgeUGCyqGSIb3DQEJ
# EAEEoIHVBIHSMIHPAgEBBgkrBgEEAaAyAgMwMTANBglghkgBZQMEAgEFAAQgqfTw
# gprBUD7qoUNrPSpAreGJxR1YLcIj6y0qa6onZMQCFCED/fb6hHMq87T0Vo+bwbhJ
# A1qmGA8yMDI0MTIxOTE3NDUyM1owAwIBAaBgpF4wXDELMAkGA1UEBhMCQkUxGTAX
...
# 9w0BCQQxIgQgEItJWJkByrict2PQFAZQKIoYnFRoVs/DKwm7btktrFUwgbAGCyqG
...
# xyXehllFnszsOrOAgkc7ix9/h7E/dTfV1zZsuRrQLZQEHI+9UmJ/kY908OvRjMeu
# wR5Vk0McrwU4GcLUiruBzOQsfDaYAT3u3Qpod/NIul+7Y4esImgrQwbEZruIuBnU
# 43Es6aRyVVp4qzKaC38CW02b3qBZ2L8JIDIthcrY46YUTkspdenUYlo+OMhjUL5/
# 3i+9ZJ6HtWzMdgHuVN1Bc0ITS1oyKENA3roHQ7Mu76EVmH2H6cpu/svDbzE9PT+c
# id1eytL9brF9TeJCLCSUojOwqWQi8/YySjaMKVDDRA6seYbPdufV4/4lV/DnftWM
# AxfXvkbwmsU/zafggNH+UitVd6BYkMqowqP4vPi5NJMk8JCJISzmN1sVIYCo/O0y
# 6I66HXgS0HwghKIXwzHcaXnz9wq8vpCKz361SbuO8sGbWcAmjQGJUhgxtWXow9OQ
# 5J/ivlvjsdBLOfbqcV7Px3YTscgqcvMQvi9cq0V5wG0RjtOhJ4R8OEFCzKM1nz8=
