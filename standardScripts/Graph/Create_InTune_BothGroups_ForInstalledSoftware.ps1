...
Write-Output "The devices which were not added to the group are as follows:`n"
Write-Output $failedDevices
...
ForEach ($user in $appObject)
{
    try{
        ...
        $IDs = (Get-MGUser -userID $user.deviceUser).id 
        if($Null -eq $IDs)
        {
            continue
        }
...
Write-Output "The users which were not added to the group are as follows:`n"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB1dySNAD2WjgbV
# lh4nzu404Vn11/o2XiVBBgXmuYTLeKCCFAUwggWQMIIDeKADAgECAhAFmxtXno4h
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIH/8CDi0UNBNSueUo6LR9NMS
# db1gPG2Y0uXrEGhnMb1QMA0GCSqGSIb3DQEBAQUABIICAH1SJREMjfqkOGi5ijYz
# n9L4gYgBtZ/Soh22OiAzAMq7/GjRqR1AfDuuJyn9Fq6O/JgdQng7gEICWJ1vSNkC
# 3kM+q1P44i8eAMnY0jbamGQtJKV6R8+AOEdnmFi+TLPmj01kOeyRH0IxO37XBY8C
# irhWuhwFjZHTUKCKE9tThqYZOxeHKuyBg+3kySKD79rAXN1/SxlMNX2K2I6RnsCx
# zHeb5wEatRBeT2ZOeR0QyalWR2obocpGXpEld3NxV4whUFZO91lDzTotdHBrz1x9
# g96HSO/JGjPvn2Gf6IgD0dnc+c7LfQP87gQ46TddzklHwxOy9PQuwCy78/hEvP30
# 5E5FVo1rScyshWh1ibE0k4RTCRggjZxuMoyYBRjz0IO5SpxQbuAuaYkxYLgVLn0C
# 3P5rOe7+gVlaXKO6npGsmTa3RBFtYzEwt0BGbJuxldwGYnl0Y21QdnP5mdJaanj0
# ASUSmVdUCpUn78KvPGfX1sTpYHuRqDm1PE6TX/EHO6WUniNIvtZv0T4NpwMQpVl/
# pAFUlgTthCBhFeRHE1ienJmOD69xRr+YymaywXaJprEeT5OK52wWwOoVlv/Qpl0f
# UmLewCFJqQGQyFc+3i3rABzNG/oohilWA3FP4+5heAByMQSfkz59hUn8vvP88pdo
# 0o0TG6HIQtEeY+hB6dzC07CGoYIWyTCCFsUGCisGAQQBgjcDAwExgha1MIIWsQYJ
# KoZIhvcNAQcCoIIWojCCFp4CAQMxDTALBglghkgBZQMEAgEwgeUGCyqGSIb3DQEJ
# EAEEoIHVBIHSMIHPAgEBBgkrBgEEAaAyAgMwMTANBglghkgBZQMEAgEFAAQgYgO6
# N0/wz7UziFn4iy+verIhDS2FUUu+Li22EGASmxICFGiKkPPJBCpOiB8IQhZ3GF7D
# 3L2aGA8yMDI0MTIxOTE4MDIyM1owAwIBAaBgpF4wXDELMAkGA1UEBhMCQkUxGTAX
...
# 9w0BCQQxIgQgcSZTDxQq3FdfXvUA6A3BAYAc4CQqc4kswXdKTZeBXmkwgbAGCyqG
...
# SEEzODQgLSBHNAIQARl1dHHJktdE36WW67lwFTANBgkqhkiG9w0BAQsFAASCAYAz
# Xdr5mOfAM/K4BYlFQ4DgNnEryD6n35+WyER7bYHnH1hJTZTsRHjZp7tKiSb2rqS2
# teiFhO0/1GJu+jMoNji66gVz44lifRuJQo+uLzZ28E0txeRyMphQxzn5XKYfEDZD
# 308n0k5dxKvJzxZxxD6RkAHjhGr6mdA8Skc0cLMAh6WlxtNrS8jWHhauE2W31bUK
# /67G69JtQxdZkoGKIU1Qe40L6GBQfciAlDLTGbz9c+JaL0l7U3She+MqljNPawqc
# KJU3vMwQ30T9o672OpUeUAquncpj2rJkMVWRslJ2jLN7eaqzMhZKA3slqHIqccfU
# lntpAXy5EdFAldAYwo/pkIsz35O+PHrzI+RL74/ImmigExH6RcwjZ90CYnSkJ3Jm
# KJvYmHrBlITl7Jcf6Sp839CSNNcg0xNTJiwB/Ziz9yqaH+t/URcU+g57oKVrXC0A
# AjIr3xDPCrc1FsvopwbgUyBRtrdD1aecbtNlXXua94PxXWUcoYB6+tFtV7AiHuw=
