...
$Manager1 = Get-MGBetaUser -userid "pstrine@uniqueParentCompany.com"
$Manager1Chain = @()
$Manager1DirectReports = Get-MGUserDirectReport -UserId $Manager1.id 

ForEach ($directReport in $Manager1DirectReports)
{
    $mgUser = $null
    $mgUser = Get-MGBetaUser -userID $directReport.id | select-object -Property "ID","UserPrincipalName","JobTitle", "DisplayName"
    $manager1Chain += [PSCustomObject]@{
        DisplayName       = $mgUser.DisplayName
        UserPrincipalName = $mgUser.UserPrincipalName
        Title        = $mgUser.jobtitle
        Supervisor = $Manager1.DisplayName 
        }
...
$Manager2 = Get-MGBetaUser -userid "chad.nagle@uniqueParentCompany.com"
$Manager2Chain = @()
$Manager2DirectReports = Get-MGUserDirectReport -userid $Manager2.id 

ForEach ($directReport in $Manager2DirectReports)
{
    $mgUser = $null
    $mgUser = Get-MGBetaUser -userID $directReport.id | select-object -Property "ID","UserPrincipalName","JobTitle", "DisplayName"
    $manager2Chain += [PSCustomObject]@{
        DisplayName       = $mgUser.DisplayName
        UserPrincipalName = $mgUser.UserPrincipalName
        Title        = $mgUser.jobtitle
        Supervisor = $Manager2.DisplayName 
        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBU9iYT4Gfgnf70
# JHAermPcb1qDjDmaowomLCVnYgBZ6aCCFAUwggWQMIIDeKADAgECAhAFmxtXno4h
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIEORznviUgjA1O2IZVJTbKwW
# rw8NFv9ATgNxzYEMuenUMA0GCSqGSIb3DQEBAQUABIICAHMbnj36gJTgYJZeqTbz
# sL0Hujv3MaVanCTFiGpiwFs8WFLA2Hzi1dZtRgqWD7adwHxe4tvaEo7shCyDoASf
# kihZih31Jnlv2Vif5HISObSp+SFCJyzOkDj1jbhBjzt6Co5XO601tAsW5XhuvBME
# jjBMwGaPWAzNC3pZ9ZzlvDN6Z1axq0cXWueO8UWCVkA62a/VQpOmB8k/uvtZrEkx
# R7a7xpxMdQxeoAJjEsVR1VFzDe17OHmXSHsA2P4TQrj3IfWDahpC8i3xm3QgzRkw
# 8BPI7Bi5cONl8t530n4pyurOQrmhkR8jb0qxK6DRdmRrTE1dBKBrLRpLuPUYEUi6
# mxTBs0fKiISUZ4VOcqdwO5s75T+Zo6WZxDbuhUD5LmSb8mV0i8ktsrQXbqApFm2V
# LpxkUWTHMydc2z1G0VP0HyYnpqAzbW5tgEzCmJ3KA8AkgNKIVOw75F+Ndr3hTKtH
# Qmw5eJdihaDkclPJkPOfhSsJjaPkZDLEusWZXnxsjz00Ln7laeWPLH5tbasjKcKY
# hOmQI/n3Q15p3VwjIsCpWfEczvuJi33UqLQvcig7aiX9Q6Y0yHIE7DolciVyBwJz
# fqNuX9kGHJrksFO2zRvu5Xcce4cczWw2qlSyJ3Qvn02LCx2tVbADfnSaoYwIHlqK
# A0svFWscofCfynqyRJprNcfxoYIWtzCCFrMGCisGAQQBgjcDAwExghajMIIWnwYJ
# KoZIhvcNAQcCoIIWkDCCFowCAQMxDTALBglghkgBZQMEAgEwgdwGCyqGSIb3DQEJ
# EAEEoIHMBIHJMIHGAgEBBgkrBgEEAaAyAgMwMTANBglghkgBZQMEAgEFAAQgsxJy
# P14/bsDrQcUFZ2wIphi0vLIVOzl5MOOjcnlN5yMCFCisTIOhnTo6qTGJ/Eot3G0A
# dNQiGA8yMDI1MDQyNTEzNTQ1NlowAwIBAaBXpFUwUzELMAkGA1UEBhMCQkUxGTAX
...
# SAFlAwQCAaENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgUnmZ5OC2gmmf
# 2AJ1by9ogbjT2FIihqX5LutB04Lf/WwwgbAGCyqGSIb3DQEJEAIvMYGgMIGdMIGa
...
# m3hD4Jl1lGN3CzANBgkqhkiG9w0BAQsFAASCAYB9dGQ6BRXB6GNsL6Tp8IKYbL61
# omXBbhNA15SA+HmhosLUh/5tlDVlWSKEocZ+Xhz25cBxb3Ht975ATXJ/QO4+bN7X
# Odt7X4MYDTy76lUjpL+ad2m5x6SNYxCRtvF9e+XcDuxZGY1e5/udUaFEsBY28s+S
# WVNeK6sGH3tExaDgmkMVX5PZqbMyqTkHf/xfZHuk619KPGWwYzTdctCgXYOw/B71
# Bsq9sfDIkXjHbUKzsTRHQg5gsM6F2z/j5iuRwqzX8t606MPnzQRb7HjOwg9ppP3+
# FuLac9a9QkMRa2WqDOEewtnPqW7EnMZtuoIq62RP6/5dEvQg41+rFQgAlC4IHZgf
# FywXuDlaRsqZMrt1N2IC6gWI5GNrZEXF5mlR9xMu1CnWarRAmG6zdY3XQP5iytjB
# JIbDiphv+BlspnRN413c5Kji+Y2yf/EuZp1WRAJGOdnlTMgcpzAWdkFz0X0RiWib
# yEc6+qnboIY7+7dcrFl10KENC1Dauai1beMVhTA=
