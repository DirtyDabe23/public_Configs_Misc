...
try{
    # Read from Azure Key Vault using managed identity
    $connection = Connect-AzAccount -Identity
    $managed_ID = Get-AzKeyVaultSecret -VaultName "US-TT-Vault" -Name "ExOManagedIdent" -AsPlainText
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCU7npqgSVaicTH
# 9aAeBsoqZr1cq58vwjZtX+FKMpafeaCCFAUwggWQMIIDeKADAgECAhAFmxtXno4h
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIMmn5RpUJhCRq0gp1pefksge
# /ZrVQpaVgLYDrSemfDTeMA0GCSqGSIb3DQEBAQUABIICAJDlLIlu85mT++fU/7Nh
# uvekl8XdG6B87L1zzIJXXO5siJ5BAKTIP58kUGomqNbu8wZxSeBZ0LLcbOFQmEG6
# julVpiI2Rqi5x6wn5FqCIzI4yNYO2MHeA5fgV8892EPb1yFUzop1p55ZlnfvVKGv
# goGCMrOTaBrXcDdfaTyQDKsNuAiZVu+Q0y4wuVzC44BUCWxA3URv3KollaqlIctz
# 0uPBboQ+k8ZbwA+4XkKMtaEtaqlQ1CtJHq/vtWm4vrHJ9KkcYBEQvxe4+s7Hq378
# MazmDjWpTCcISPskLFnZYXDOPI9Y/4ng+VD2KCmZzZ5EnPGzZ+K/GPFCm5iW43va
# dyyjTafdKksubaq/2U/egEOvGTzmXL2lLRN7K6DBcaHdsf2aL87AoYYQfZHEmxcs
# ys3xWHowx4NSml8SoeSmLxYSuKKdDarHclRlzBF08+iKRfQj+iYE1iRkQRHzYrjV
# tRhbHS277s5Z65lU5Avs5N3NYUJqOqiFuSGBHU2IQbHqhDvj5tfnwN7TNUk5gcCg
# ihHk8ZhsNIu5F8WZpe6cKKlEqsxLH1cJROyFR59SJqi4/jAz+JjS2JB7UFEazrhR
# yWmxC6+diTITbFRDhbelRHeIgjgfRxxEbrXP4GCD/mHKW8Nq34XoYBavvk2CH0Yw
# 5jcx6xYs4nOx/B+mQU+dEU6+oYIWtzCCFrMGCisGAQQBgjcDAwExghajMIIWnwYJ
# KoZIhvcNAQcCoIIWkDCCFowCAQMxDTALBglghkgBZQMEAgEwgdwGCyqGSIb3DQEJ
# EAEEoIHMBIHJMIHGAgEBBgkrBgEEAaAyAgMwMTANBglghkgBZQMEAgEFAAQg6GoK
# WiEV3e+auSC81Ye+vMA59xFHR8N8NHLEBHyCxEgCFCTRqO276bdNkzxC1GVtTWYm
# xJC8GA8yMDI1MDQxNjEyNTA0M1owAwIBAaBXpFUwUzELMAkGA1UEBhMCQkUxGTAX
...
# SAFlAwQCAaENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgp4Dcu0gE+0fj
# ur8+yckqywIVyaoOd0gNihNp+c1y4EYwgbAGCyqGSIb3DQEJEAIvMYGgMIGdMIGa
...
# m3hD4Jl1lGN3CzANBgkqhkiG9w0BAQsFAASCAYCI/hMOJUMHzf+C7eFYNp/a28ID
# 74RXwXz4PREFOlABF/FpTmurax0nLxgG8gd90eLCtnJ++Xsv5uCCDe6Lj90l2RYB
# wlxRZaTQ6SyB+Kd+OZ1xl5eWA/Et9LqvwdUDPksUxw1m8LKBv3A5d68KKbUcbMA4
# kkSJkjlmcLUTDadli9usE8ylPy+mU+9nLOY+Jxcq9DWF+P39W67aiVeYZIn4O1EL
# hYog3JGwu2FxR0pKiwP0pDlECfTB6kOno7l8pw3eyQ8jSg/65wolKFxRs3IDm5Ba
# mO7mC3ZDcjbQjx0KGWPAT2ppkCiLPQZ5Geefa+zsm1BwDcKOQL1vG0cT4aSAQUHs
# nXQdAGvsEnhHYPXdq7Tus+FE+9AkAdq+fAvhv3NnRaLk5mOMROayx5/qPvZpxv6Z
# Iemj644gfXVCHuAyE8uK1XNE3iLnmPcI+xUcWFhkWci5rUJAGwJSmP8KH3HsQseo
# Sl1mldMS/RuQy3X9JvpqaTD/5YsyFEFCEQSam84=
